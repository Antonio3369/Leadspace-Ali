...
登录后先选择业务线：**小蓝环**（完整看板）或 **支付宝 N7**（今日待办 / 达标跟进 / 数据看板 / 处理状态）。产品约定与路由详见 [Leadspace.Ali.md](./Leadspace.Ali.md)（**最后更新 2026-07-20**）。
...
- **今日待办** `/n7`：按紧急度作业（今日必跟 / 其余待跟进，预览 10 条）；未处理为数字卡入口；复盘进 `/n7/board`
- **达标跟进** `/n7/follow-up` · 队员明细 · 设备详情
