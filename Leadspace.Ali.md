...
**最后更新**：2026-09-08（小绿盒看板去掉说明文案 · **已部署** `__HASH__`）
...
| `/xlv/board` | **团队看板**：顶栏合规/已铺设与距 90% 差几台；终身已达标单独一行。名单每人「本人 n/m 台合规」。看重点：**看健康** / **该催谁** / **跟进成效**。队员行合并账号 + 同名未绑定 |
