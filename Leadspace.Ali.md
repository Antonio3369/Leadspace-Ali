...
**最后更新**：2026-09-08（小绿盒：达标按已铺设、不按拓展月切开 · **已部署** `159ff70`）
...
| 小绿盒看板 | `/xlv/alerts` 六宫格：**已达标 / 达标率按全部已铺设**（往月未达标当月继续考核，不限首笔月）；**本月/上月拓展**只统计该月新铺；沉睡 / 单笔沉默为当前状态。列表**默认全部已铺设**，点「本月拓展」才按首笔月筛。日期区间与中国日历日对齐（跟进按北京时间）。**考核中**卡片展示当月成绩 + 距目标缺口，至今累计只在详情。`/xlv/board` 经理排行；**`/xlv/admin/companies` 分公司排名看板** |
